...
const H2 = ({ children }: { children: ReactNode }) => (
  <h2 className="text-xl font-bold mt-5">{children}</h2>
);
...
export default function ServicePage({
  ...
  return (
    <div>
      <img
        src={"/assets/images/bg_services.jpg"}
        alt={"Banner Service"}
        className="w-full"
      />
      <div className="mx-auto md:max-w-screen-xl">
        <div className="py-10">
          <h1 className="text-center text-3xl font-black">
            {content[params.slug].title}
          </h1>
          <div className="mt-5">{content[params.slug].description}</div>
